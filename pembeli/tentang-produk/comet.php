...
<head>
    ...
    <title>Comet - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../comet.jpeg" alt="Comet">
        <div class="product-detail">
            <div class="product-title">Comet</div>
            <div class="product-info">Comet adalah jajanan manis berbentuk bulat kecil, berwarna-warni, dan renyah di luar, lembut di dalam. Cocok untuk camilan anak-anak maupun dewasa.</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="comet">
    <input type="hidden" name="nama_produk" value="Comet">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../comet.jpeg">
    <input type="hidden" name="file_produk" value="comet.php">
