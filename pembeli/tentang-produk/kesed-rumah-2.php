...
<body>
    <div class="container">
        <img class="product-img" src="../kesed rumah 2.jpeg" alt="Kesed Rumah 2">
        <div class="product-detail">
            <div class="product-title">Kesed Rumah 2</div>
            <div class="product-info">
                Kesed rumah rajut dengan motif unik dan bahan kain tebal.
                Tahan lama, mudah dicuci, serta memberikan kenyamanan saat digunakan.
                Sangat cocok untuk ruang tamu maupun dapur.
            </div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="kesed-rumah-2">
                        <input type="hidden" name="nama_produk" value="Kesed Rumah 2">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../kesed (2).jpeg">
