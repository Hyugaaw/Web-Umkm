...
<body>
    <div class="container">
        <img class="product-img" src="../Rajut Botol.jpeg" alt="Rajut Botol">
        <div class="product-detail">
            <div class="product-title">Rajut Botol</div>
            <div class="product-info">
                Rajut Botol merupakan kerajinan tangan unik berbahan dasar tali rajut yang membungkus botol bekas, menghasilkan produk fungsional dan estetis. Cocok dijadikan dekorasi rumah atau hadiah ramah lingkungan.
            </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="rajut-botol">
    <input type="hidden" name="nama_produk" value="Rajut Botol">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Rajut Botol.jpeg">
