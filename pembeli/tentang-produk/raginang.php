...
<body>
    <div class="container">
        <img class="product-img" src="../raginang.jpeg" alt="Raginang">
        <div class="product-detail">
            <div class="product-title">Raginang</div>
            <div class="product-info">
                Raginang merupakan camilan tradisional khas Indonesia yang terbuat dari beras ketan dan dibumbui secara khas, menghasilkan rasa gurih dan renyah di setiap gigitan. Cocok dinikmati bersama teh atau kopi.
            </div>
            <div class="product-price">Rp <span id="harga-produk">15.000</span></div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="raginang">
    <input type="hidden" name="nama_produk" value="Raginang">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../raginang.jpeg">
