...
<body>
    <div class="container">
        <img class="product-img" src="../kesed rumah.jpeg" alt="Kesed Rumah">
        <div class="product-detail">
            <div class="product-title">Kesed Rumah </div>
            <div class="product-info">
                Kesed rumah berkualitas dengan bahan kain pilihan, nyaman digunakan, daya serap tinggi, 
                serta desain menarik untuk mempercantik rumah Anda. Cocok ditempatkan di depan pintu atau kamar mandi.
            </div>
            <div class="product-price">Rp <span id="harga-produk">25.000</span></div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="kesed-rumah">
    <input type="hidden" name="nama_produk" value="Kesed Rumah">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../kesed (1).jpeg">
...
<?php endif; ?>
    ...
    <script>
        function ubahJumlah(delta) {
            ...
            if (val < 1) val = 1;
            input.value = val;
            // Jika ada form, update juga input hidden jumlah
