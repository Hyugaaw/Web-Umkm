...
<body>
    <div class="container">
        <img class="product-img" src="../keripik singkong 2.jpeg" alt="Keripik Singkong">
        <div class="product-detail">
            <div class="product-title">Keripik Singkong 2</div>
            <div class="product-info">Keripik singkong renyah dengan rasa gurih khas Indonesia. Cocok dijadikan camilan saat santai atau teman nonton.</div>
            <div class="product-price">Rp <span id="harga-produk">7.000</span></div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="keripik-singkong-2">
                        <input type="hidden" name="nama_produk" value="Keripik Singkong 2">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../keripik singkong 2.jpeg">
