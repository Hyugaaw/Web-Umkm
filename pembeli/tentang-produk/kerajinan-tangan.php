...
<body>
    <div class="container">
        <img class="product-img" src="../kerajinan tangan.jpeg" alt="Kerajinan Tangan">
        <div class="product-detail">
            <div class="product-title">Kerajinan Tangan</div>
            <div class="product-info">Kerajinan tangan unik berbahan alami, dibuat dengan detail halus dan kualitas terbaik. Cocok untuk hiasan rumah maupun hadiah istimewa.</div>
            <div class="product-price">Rp <span id="harga-produk">45.000</span></div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="kerajinan-tangan">
                        <input type="hidden" name="nama_produk" value="Kerajinan Tangan">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../kerajinan tangan.jpeg">
