...
?>
    ...
    <body>
        <div class="container">
            <img class="product-img" src="../keripik pisang.jpeg" alt="Keripik Pisang">
            <div class="product-detail">
                <div class="product-title">Keripik Pisang</div>
                <div class="product-info">Keripik pisang manis dan gurih, dibuat dari pisang pilihan yang digoreng renyah. Cocok untuk camilan sehari-hari.</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="keripik-pisang">
    <input type="hidden" name="nama_produk" value="Keripik Pisang">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../keripik pisang.jpeg">
    <input type="hidden" name="file_produk" value="keripik-pisang.php">
