...
<head>
    ...
    <title>Gehu - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Gehu.jpeg" alt="Gehu">
        <div class="product-detail">
            <div class="product-title">Gehu</div>
            <div class="product-info">Gehu adalah tahu isi sayuran khas Indonesia yang digoreng hingga renyah. Cocok sebagai camilan gurih yang praktis dan lezat.</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="gehu">
    <input type="hidden" name="nama_produk" value="Gehu">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Gehu.jpeg">
    <input type="hidden" name="file_produk" value="gehu.php">
...
<?php endif; ?>
    ...
    <script>
        ...
        // Alert jumlah barang saat klik tombol
