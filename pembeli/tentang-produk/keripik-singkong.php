...
<body>
    <div class="container">
        <img class="product-img" src="../keripik singkong.jpeg" alt="Keripik Singkong">
        <div class="product-detail">
            <div class="product-title">Keripik Singkong</div>
            <div class="product-info">Keripik singkong renyah dengan rasa gurih. Cocok untuk camilan ringan kapan saja.</div>
            <div class="product-price">Rp <span id="harga-produk">5.000</span></div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="keripik-singkong">
                        <input type="hidden" name="nama_produk" value="Keripik Singkong">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../keripik singkong.jpeg">
                        <input type="hidden" name="file_produk" value="keripik-singkong.php">
