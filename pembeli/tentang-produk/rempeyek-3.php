...
<head>
    ...
    <title>Rempeyek Kacang Tanah - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../rempeyek 3.jpeg" alt="Rempeyek Kacang Tanah">
        <div class="product-detail">
            <div class="product-title">Rempeyek 3</div>
            <div class="product-info">
                Rempeyek Kacang Tanah adalah camilan tradisional gurih yang dibuat dari adonan tepung beras dengan taburan kacang tanah pilihan. Teksturnya renyah, rasanya gurih, dan sangat cocok untuk teman makan nasi atau camilan di waktu santai.
            </div>
            <div class="product-price">Rp <span id="harga-produk">18.000</span></div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="rempeyek-3">
                        <input type="hidden" name="nama_produk" value="Rempeyek Kacang Tanah">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../rempeyek 3.jpeg">
                        <input type="hidden" name="file_produk" value="rempeyek-3.php">
