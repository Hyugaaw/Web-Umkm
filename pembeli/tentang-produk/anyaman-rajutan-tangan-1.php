...
<body>
    <div class="container">
        <img class="product-img" src="../Anyaman Rajutan tangan 1.jpeg" alt="Anyaman Rajutan Tangan (1)">
        <div class="product-detail">
            <div class="product-title">Anyaman Rajutan Tangan (1)</div>
            <div class="product-info">Kerajinan tangan unik, cocok untuk dekorasi rumah.</div>
            <div class="product-price">Rp <span id="harga-produk"></span>75.000</div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        ...
                        <input type="hidden" name="nama_produk" value="Anyaman Rajutan Tangan (1)">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../Anyaman Rajutan tangan 1.jpeg">
