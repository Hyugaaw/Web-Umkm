...
<head>
    ...
    <title>Es Lilin - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Es Lilin.jpeg" alt="Es Lilin">
        <div class="product-detail">
            <div class="product-title">Es Lilin</div>
            <div class="product-info">Es Lilin adalah es tradisional khas Sunda yang terbuat dari santan, gula, dan aneka rasa buah, disajikan dalam plastik kecil seperti lilin. Segar dan cocok dinikmati saat cuaca panas.</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="es-lilin">
    <input type="hidden" name="nama_produk" value="Es Lilin">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Es Lilin.jpeg">
    <input type="hidden" name="file_produk" value="es-lilin.php">
