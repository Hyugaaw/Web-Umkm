...
<head>
    ...
    <title>Basreng 2 - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../bAsreng 2.jpeg" alt="Basreng 2">
        <div class="product-detail">
            <div class="product-title">Basreng 2</div>
            <div class="product-info">Basreng (Bakso Goreng) varian pedas, renyah dan gurih, cocok untuk camilan kapan saja.
            </div>
            <div class="product-price">Rp <span id="harga-produk"></span>2.000</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="basreng-2">
    <input type="hidden" name="nama_produk" value="Basreng 2">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../bAsreng 2.jpeg">
    <input type="hidden" name="file_produk" value="basreng-2.php">
