...
<head>
    ...
    <title>Telor Gabus - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../telor gabus.jpeg" alt="Telor Gabus">
        <div class="product-detail">
            <div class="product-title">Telor Gabus</div>
            <div class="product-info">
                Telor Gabus adalah camilan khas Indonesia berbentuk kecil memanjang dengan tekstur renyah dan rasa gurih. Dibuat dari campuran tepung tapioka dan telur yang digoreng hingga garing. Cocok untuk camilan ringan di segala suasana.
            </div>
            <div class="product-price">Rp <span id="harga-produk">20.000</span></div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="telor-gabus">
    <input type="hidden" name="nama_produk" value="Telor Gabus">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../telor gabus.jpeg">
    <input type="hidden" name="file_produk" value="telor-gabus.php">
