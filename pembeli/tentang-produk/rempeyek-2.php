...
<head>
    ...
    <title>Rempeyek Kacang Gurih - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../rempeyek 2.jpeg" alt="Rempeyek Kacang Gurih">
        <div class="product-detail">
            <div class="product-title">Rempeyek 2</div>
            <div class="product-info">
                Rempeyek Kacang Gurih adalah camilan tradisional khas Nusantara yang dibuat dari adonan tepung beras,
                kacang tanah pilihan, dan rempah-rempah yang harum. Renyah, gurih, dan cocok dinikmati kapan saja sebagai teman makan atau camilan sore hari.
            </div>
            <div class="product-price">Rp <span id="harga-produk">22.000</span></div>

            <div style="margin-bottom:18px; display:flex; align-items:center; gap:10px;">
                <label for="jumlah-barang" style="font-weight:600;">Jumlah:</label>
                <button type="button" onclick="ubahJumlah(-1)"
                    style="width:32px; height:32px; font-size:20px; border-radius:6px; border:1px solid #ccc; background:#eee; cursor:pointer;">-</button>
                <input type="text" id="jumlah-barang" name="jumlah-barang" value="1" readonly
                    style="width:70px; padding:7px 10px; border-radius:6px; border:1px solid #ccc; font-size:16px; text-align:center; background:#f9f9f9; cursor:default;">
                <button type="button" onclick="ubahJumlah(1)"
                    style="width:32px; height:32px; font-size:20px; border-radius:6px; border:1px solid #ccc; background:#eee; cursor:pointer;">+</button>
            </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="rempeyek-2">
    <input type="hidden" name="nama_produk" value="Rempeyek Kacang Gurih">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../rempeyek 2.jpeg">
    <input type="hidden" name="file_produk" value="rempeyek-2.php">
