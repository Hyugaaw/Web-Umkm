...
<head>
    ...
    <title>Anyaman Rajutan Tangan (4) - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Anyaman Rajutan tangan 4.jpeg" alt="Anyaman Rajutan Tangan (4)">
        <div class="product-detail">
            <div class="product-title">Anyaman Rajutan Tangan (4)</div>
            <div class="product-info">Kerajinan tangan kreatif, cocok untuk mempercantik ruangan atau sebagai hadiah spesial.
            </div>
            <div class="product-price">Rp <span id="harga-produk"></span>90.000</div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        ...
                        <input type="hidden" name="nama_produk" value="Anyaman Rajutan Tangan (4)">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../Anyaman Rajutan tangan 4.jpeg">
                        <input type="hidden" name="file_produk" value="anyaman-rajutan-tangan-4.php">
    ...
    <script>
        ...
        // Alert jumlah barang saat klik tombol (simulasi, karena belum ada backend keranjang)
