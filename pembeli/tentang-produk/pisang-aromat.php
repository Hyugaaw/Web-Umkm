...
<head>
    ...
    <title>Pisang Aromat - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../pisang aromat.jpeg" alt="Pisang Aromat">
        <div class="product-detail">
            <div class="product-title">Pisang Aromat</div>
            <div class="product-info">
                Pisang aromat dengan cita rasa khas, digoreng renyah dengan balutan tepung berbumbu. Pas untuk camilan gurih saat santai.
            </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="pisang-aromat">
    <input type="hidden" name="nama_produk" value="Pisang Aromat">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../pisang aromat.jpeg">
