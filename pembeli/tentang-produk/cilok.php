...
<body>
    <div class="container">
        <img class="product-img" src="../cilok.jpeg" alt="Cilok">
        <div class="product-detail">
            <div class="product-title">Cilok</div>
            <div class="product-info">Cilok kenyal khas Bandung, disajikan dengan bumbu kacang gurih, cocok untuk camilan kapan saja.</div>
            <div class="product-price">Rp <span id="harga-produk"></span>5.000</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="cilok">
    <input type="hidden" name="nama_produk" value="Cilok">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../cilok.jpeg">
