...
<head>
    ...
    <title>Cuhcur - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Cuhcur.jpeg" alt="Cuhcur">
        <div class="product-detail">
            <div class="product-title">Cuhcur</div>
            <div class="product-info">Cuhcur adalah kue tradisional khas Sunda berbentuk bulat pipih, berwarna coklat keemasan, manis dan legit, cocok untuk teman minum teh atau kopi.</div>
            <div class="product-price">Rp <span id="harga-produk"></span>3.000</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="cuhcur">
    <input type="hidden" name="nama_produk" value="Cuhcur">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Cuhcur.jpeg">
    <input type="hidden" name="file_produk" value="cuhcur.php">
