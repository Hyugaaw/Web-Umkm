...
<body>
    <div class="container">
        <img class="product-img" src="../rempeyek 1.jpeg" alt="Rempeyek Kacang">
        <div class="product-detail">
            <div class="product-title">Rempeyek </div>
            <div class="product-info">
                Rempeyek Kacang adalah camilan tradisional Indonesia yang gurih dan renyah, terbuat dari adonan tepung beras dengan kacang tanah dan bumbu rempah pilihan. 
                Cocok dinikmati sebagai teman makan nasi atau camilan saat santai.
            </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="rempeyek-1">
    <input type="hidden" name="nama_produk" value="Rempeyek Kacang">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../rempeyek 1.jpeg">
