...
<body>
    <div class="container">
        <img class="product-img" src="../basreng.jpeg" alt="Basreng 2">
        <div class="product-detail">
            <div class="product-title">Basreng </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="basreng">
    <input type="hidden" name="nama_produk" value="Basreng">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../basreng.jpeg">
    <input type="hidden" name="file_produk" value="basreng.php">
