...
<body>
    <div class="container">
        <img class="product-img" src="../kerajinan tangan 2.jpeg" alt="Kerajinan Tangan 2">
        <div class="product-detail">
            <div class="product-title">Kerajinan Tangan 2</div>
            <div class="product-info">Kerajinan tangan berbahan kayu dengan ukiran detail, cocok sebagai dekorasi rumah atau pajangan artistik. Dibuat secara handmade dengan ketelitian tinggi.</div>
            <div class="product-price">Rp <span id="harga-produk">35.000</span></div>
            ...
            <div class="btn-container">
                <?php if ($is_logged_in): ?>
                    <form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="kerajinan-tangan-2">
                        <input type="hidden" name="nama_produk" value="Kerajinan Tangan Kayu">
                        <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
                        <input type="hidden" name="gambar" value="../kerjinan tangan (2).jpeg">
