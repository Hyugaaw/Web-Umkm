...
<head>
    ...
    <title>Martabak - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Martabak.jpeg" alt="Martabak">
        <div class="product-detail">
            <div class="product-title">Martabak</div>
            <div class="product-info">
                Martabak manis dengan topping melimpah, dibuat dari bahan premium. Cocok untuk dinikmati bersama keluarga dan teman.
            </div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="martabak">
    <input type="hidden" name="nama_produk" value="Martabak">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Martabak.jpeg">
