...
<body>
    <div class="container">
        <img class="product-img" src="../keripik pisang 2.jpeg" alt="Keripik Pisang">
        <div class="product-detail">
            <div class="product-title">Keripik Pisang 2</div>
            <div class="product-info">Keripik pisang renyah dengan rasa manis alami. Dibuat dari pisang pilihan yang digoreng hingga garing dan lezat.</div>
            <div class="product-price">Rp <span id="harga-produk">10.000</span></div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="keripik-pisang-2">
    <input type="hidden" name="nama_produk" value="Keripik Pisang 2">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../keripik pisang 2.jpeg">
