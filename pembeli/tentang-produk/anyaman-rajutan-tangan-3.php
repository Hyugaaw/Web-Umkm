...
<head>
    ...
    <title>Anyaman Rajutan Tangan (3) - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../Anyaman Rajutan tangan 3.jpeg" alt="Anyaman Rajutan Tangan (3)">
        <div class="product-detail">
            <div class="product-title">Anyaman Rajutan Tangan (3)</div>
            <div class="product-info">Produk handmade eksklusif, menambah nilai estetika ruangan Anda.</div>
            <div class="product-price">Rp <span id="harga-produk"></span>65.000</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    ...
    <input type="hidden" name="nama_produk" value="Anyaman Rajutan Tangan (3)">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../Anyaman Rajutan tangan 3.jpeg">
    <input type="hidden" name="file_produk" value="anyaman-rajutan-tangan-3.php">
