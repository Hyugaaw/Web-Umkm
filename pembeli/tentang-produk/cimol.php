...
<head>
    ...
    <title>Cimol - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../cimol.jpeg" alt="Cimol">
        <div class="product-detail">
            <div class="product-title">Cimol</div>
            <div class="product-info">Cimol gurih dan kenyal, jajanan khas Bandung yang digemari semua kalangan.</div>
            <div class="product-price">Rp <span id="harga-produk"></span>10.000</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="cimol">
    <input type="hidden" name="nama_produk" value="Cimol">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../cimol.jpeg">
    <input type="hidden" name="file_produk" value="cimol.php">
