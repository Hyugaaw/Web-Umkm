...
<head>
    ...
    <title>Bala-Bakwan - Detail Produk</title>
    <style>
        body {
...
<body>
    <div class="container">
        <img class="product-img" src="../bala bakwan.jpeg" alt="Bala-Bakwan">
        <div class="product-detail">
            <div class="product-title">Bala-Bakwan</div>
            <div class="product-info">Gorengan tradisional khas Indonesia, renyah dan gurih, cocok untuk camilan atau teman minum teh.</div>
...
<form method="post" action="../keranjang/tambah-keranjang.php" style="display:inline;">
    <input type="hidden" name="id_produk" value="bala-bakwan">
    <input type="hidden" name="nama_produk" value="Bala-Bakwan">
    <input type="hidden" name="jumlah" id="input-jumlah-barang" value="1">
    <input type="hidden" name="gambar" value="../bala bakwan.jpeg">
    <input type="hidden" name="file_produk" value="bala-bakwan.php">
