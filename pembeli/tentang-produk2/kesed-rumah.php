...
<head>
    ...
    <title>Kesed Rumah - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <div class="container">
        <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Kesed Rumah">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Kesed Rumah') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Kesed rumah berkualitas dengan bahan kain pilihan, nyaman digunakan, daya serap tinggi, serta desain menarik untuk mempercantik rumah Anda. Cocok ditempatkan di depan pintu atau kamar mandi.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Kesed Rumah') ?>">
                    ...
                    <input type="hidden" name="file_produk" value="kesed-rumah.php">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'kesed-rumah') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Kesed Rumah') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
