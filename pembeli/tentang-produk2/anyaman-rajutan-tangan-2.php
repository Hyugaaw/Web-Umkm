...
$nama_produk = 'Anyaman Rajutan Tangan 2';
...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Anyaman Rajutan Tangan (2)">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 2') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Kerajinan tangan berkualitas, cocok untuk hadiah atau koleksi pribadi.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 2') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'anyaman-rajutan-tangan-2') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 2') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
