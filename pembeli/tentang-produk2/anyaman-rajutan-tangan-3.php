...
$nama_produk = 'Anyaman Rajutan Tangan 3';
...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Anyaman Rajutan Tangan (3)">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 3') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Produk handmade eksklusif, menambah nilai estetika ruangan Anda.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 3') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'anyaman-rajutan-tangan-3') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Anyaman Rajutan Tangan 3') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
