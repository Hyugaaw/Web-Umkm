    ...
    <body>
        <div class="container">
            ...
            <div class="product-detail">
                <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Keripik Pisang') ?></div>
                <div class="product-info">
                    <?= htmlspecialchars($produk['deskripsi'] ?? 'Keripik pisang manis dan gurih, dibuat dari pisang pilihan yang digoreng renyah. Cocok untuk camilan sehari-hari.') ?>
                </div>
                ...
                <div class="btn-container">
                    <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                        ...
                        <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Keripik Pisang') ?>">
                    ...
                    <form method="post" action="./checkout/checkout.php" style="display:inline;">
                        <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'keripik-pisang') ?>">
                        <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Keripik Pisang') ?>">
                        <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
