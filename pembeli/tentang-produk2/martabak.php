...
<head>
    ...
    <title>Martabak Manis Cokelat Keju - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <div class="container">
        <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Martabak Manis Cokelat Keju">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Martabak') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Martabak manis lembut dengan topping cokelat dan keju melimpah. Dibuat dari bahan premium dan dipanggang dengan sempurna, menghasilkan cita rasa manis gurih yang menggoda selera. Cocok untuk camilan malam bersama keluarga atau teman.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Martabak') ?>">
                    ...
                    <input type="hidden" name="file_produk" value="martabak.php">
                ...
                <form method="post" action="../checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'martabak') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Martabak') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
