...
$nama_produk = 'Kerajinan Tangan 2';
...
<head>
    ...
    <title>Kerajinan Tangan 2 - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Kerajinan Tangan 2">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Kerajinan Tangan 2') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Kerajinan tangan berbahan kayu dengan ukiran detail, cocok sebagai dekorasi rumah atau pajangan artistik. Dibuat secara handmade dengan ketelitian tinggi.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Kerajinan Tangan 2') ?>">
                    ...
                    <input type="hidden" name="file_produk" value="kerajinan-tangan-2.php">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'kerajinan-tangan-2') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Kerajinan Tangan 2') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
