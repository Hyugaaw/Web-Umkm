...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Bala-Bakwan">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Bala-Bakwan') ?></div>
                <div class="product-info">
                    <?= htmlspecialchars($produk['deskripsi'] ?? 'Gorengan tradisional khas Indonesia, renyah dan gurih, cocok untuk camilan atau teman minum teh.') ?>
                </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Bala-Bakwan') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'bala-bakwan') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Bala-Bakwan') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
