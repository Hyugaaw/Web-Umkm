...
<head>
    ...
    <title>Raginang - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <div class="container">
        <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Raginang">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Raginang') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Raginang adalah camilan tradisional khas Sunda yang terbuat dari ketan dan digoreng hingga renyah. Memiliki rasa gurih dan tekstur garing yang pas untuk menemani waktu santai. Dibuat tanpa bahan pengawet dengan cita rasa autentik yang menggugah selera.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Raginang') ?>">
                    ...
                    <input type="hidden" name="file_produk" value="raginang.php">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'raginang') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Raginang') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
