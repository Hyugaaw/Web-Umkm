...
// Ambil data produk dari database berdasarkan nama
$nama_produk = 'Telor Gabus';
...
<body>
    ...
    ?>
    <div class="container">
        <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Telor Gabus">
        <div class="product-detail">
            <div class="product-title">Telor Gabus</div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Telor Gabus adalah camilan ringan berbentuk stik kecil dengan rasa gurih dan tekstur renyah. Dibuat dari campuran tepung tapioka dan telur pilihan tanpa bahan pengembang, menghasilkan rasa autentik yang disukai semua kalangan. Cocok disantap sambil bersantai atau sebagai teman minum teh dan kopi.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Telor Gabus') ?>">
                ...
                <form method="post" action="../checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'telor-gabus') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Telor Gabus') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
