...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Cimol">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Cimol') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Cimol gurih dan kenyal, jajanan khas Bandung yang digemari semua kalangan.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Cimol') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'cimol') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Cimol') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
