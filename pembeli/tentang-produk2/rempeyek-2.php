...
<head>
    ...
    <title>Rempeyek Ikan Teri - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <div class="container">
        <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Rempeyek Ikan Teri">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Rempeyek 2') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Rempeyek Ikan Teri merupakan variasi rempeyek dengan tambahan ikan teri yang gurih dan kaya rasa. Dibalut dengan adonan tepung beras berbumbu khas, setiap gigitan menghadirkan sensasi renyah dan cita rasa laut yang lezat. Cocok dinikmati sebagai lauk pendamping atau cemilan kapan saja.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Rempeyek 2') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'rempeyek-2') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Rempeyek 2') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
