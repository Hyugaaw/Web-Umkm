...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Comet">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Comet') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Comet adalah jajanan manis berbentuk bulat kecil, berwarna-warni, dan renyah di luar, lembut di dalam. Cocok untuk camilan anak-anak maupun dewasa.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Comet') ?>">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'comet') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Comet') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
