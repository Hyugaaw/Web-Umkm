...
$nama_produk = 'Keripik Singkong 2';
...
<head>
    ...
    <title>Keripik Singkong - Detail Produk</title>
    <style>
        body {
...
<body>
    ...
    ?>
    <img class="product-img" src="<?= htmlspecialchars($gambar_produk) ?>" alt="Keripik Singkong">
        <div class="product-detail">
            <div class="product-title"><?= htmlspecialchars($produk['nama'] ?? 'Keripik Singkong 2') ?></div>
            <div class="product-info">
                <?= htmlspecialchars($produk['deskripsi'] ?? 'Keripik singkong renyah dengan rasa gurih khas Indonesia. Cocok dijadikan camilan saat santai atau teman nonton.') ?>
            </div>
            ...
            <div class="btn-container">
                <form method="post" action="./keranjang/tambah-keranjang.php" style="display:inline;" id="form-keranjang">
                    ...
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Keripik Singkong 2') ?>">
                    ...
                    <input type="hidden" name="file_produk" value="keripik-singkong-2.php">
                ...
                <form method="post" action="./checkout/checkout.php" style="display:inline;">
                    <input type="hidden" name="id_produk" value="<?= htmlspecialchars($produk['slug'] ?? 'keripik-singkong-2') ?>">
                    <input type="hidden" name="nama_produk" value="<?= htmlspecialchars($produk['nama'] ?? 'Keripik Singkong 2') ?>">
                    <input type="hidden" name="harga" value="<?= $produk['harga'] ?>">
