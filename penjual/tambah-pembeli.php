...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nama) || empty($email) || empty($password)) {
        ...
        if ($cek->num_rows > 0) {
            ...
            // Insert ke database
            $stmt = $conn->prepare("INSERT INTO pengguna (nama, email, kata_sandi_hash, peran, disetujui, dibuat_pada, diperbarui_pada) VALUES (?, ?, ?, 'pembeli', ?, NOW(), NOW())");
...
<body>
    ...
    <div class="container my-4">
        <h2 class="section-title">Tambah Pembeli</h2>
        ...
        <div class="card p-4">
            <form method="POST" action="">
                ...
                <button type="submit" class="btn btn-success"><i class="bi bi-plus-circle"></i> Tambah Pembeli</button>
                <a href="pembeli.php" class="btn btn-secondary ms-2">Kembali</a>
            </form>
        </div>
    </div>
